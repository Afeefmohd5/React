...
<div className=" "> 
 ...
 {/* Display navigation links on desktop */}
      <div
        className={`${isOpen ? "flex flex-col items-center border-t-4" : "hidden"
          } md:flex md:flex-col md:items-center gap-5 w-full   `}
      >
        <Link
          to={"/"}
    ...
    <nav className='flex items-center justify-around w-full z-50 fixed bottom-0 py-5 bg-zinc-900  left-0  md:hidden '>
    
        <Link
          to={"/"}
          className="text-white block py-1 mt-3 md:mt-0 hover:bg-slate-950    text-center px-3"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-w-10">
