...
const Home = () => {
  ...
  return (
    <div className="container relative gap-5 md:gap-5 flex flex-col md:flex-row justify-center items-center h-full mx-auto p-4">
      ...
      <div className="md:w-1/2 w-full text-black z-10 flex flex-col gap-4">
        <h1 className="text-3xl font-bold mb-4">
          Hello, I am <span className="text-purple-900" ref={textRef}></span>{" "}
        </h1>
        <p className="text-lg">
        ...
        <div className="text-lg text-purple-950 ">Objective:
